...
xhook.before(function (request) {
    ...
    /* Allows fetching all replies in chat2 character history. EXPERIMENTAL FEATURE
    const HISTORIES_CHAT2_URL = "https://neo.character.ai/chats/?character_ids=";
    if (request.url.includes(HISTORIES_CHAT2_URL) && request.method === "GET") {
        request.url = request.url.replace(/num_preview_turns=2/, 'num_preview_turns=999');
        return;
    }
    */
});
