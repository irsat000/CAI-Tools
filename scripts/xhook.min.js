...
xhook.after(function (request, response) {
    ...
    /* DEPRECATED AFTER MORE MOBILE SOLUTION TO FINDING CURRENT CONVERSATION ID
    ...
    const CHAT2_URL = "neo.character.ai/turns/";
        ...
        try {
            ...
            // If meta exists, modify it
            const meta = document.querySelector('meta[cai_currentConverExtId]');
            if (meta) {
