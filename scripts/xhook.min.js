...
xhook.before(function (request) {
    ...
    const HISTORIES_URL = "character.ai/chat/character/histories/";
...
xhook.after(function (request, response) {
    ...
    const CONVERSATION_URL = "character.ai/chat/history/msgs/user/?history_external_id=";
    if (!request.url.includes(HISTORIES_URL) &&
        !request.url.includes(HISTORIES_INFO) &&
        !request.url.includes(CONVERSATION_URL)) {
        return;
    }
    ...
    else if (request.url.includes(CONVERSATION_URL)) {
        const AccessToken = request.headers.Authorization;
        createAccessTokenMeta(AccessToken);
